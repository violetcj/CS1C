...
// Q#1
/*
 * What kinds of operations must type InputIterator and type EqualityComparible support
 * (i.e. what are the type requirements) such that find is able to work?
 * 
 * For InputIterator, only single-pass operations can be used. And with EqualityComparable
 * would only be able to compare input iterators with other iterators
 *
 */
